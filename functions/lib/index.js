...
exports.exchangePayPalOAuth = exports.getAdminPayPalEmailCallable = exports.processWalletTopUp = exports.requestHostWithdrawal = exports.autoProcessAdminPayout = exports.autoProcessHostPayout = exports.processAdminPayoutFunction = exports.processHostPayoutFunction = exports.generateVerificationLink = void 0;
 ...
 */
exports.processWalletTopUp = functions.region('us-central1').https.onCall(async (data, context) => {
    var _a, _b, _c, _d, _e;
    // Verify authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    ...
    try {
        ...
        const orderAmount = parseFloat(((_b = (_a = order.purchase_units[0]) === null || _a === void 0 ? void 0 : _a.amount) === null || _b === void 0 ? void 0 : _b.value) || '0');
        ...
        const capture = (_e = (_d = (_c = order.purchase_units[0]) === null || _c === void 0 ? void 0 : _c.payments) === null || _d === void 0 ? void 0 : _d.captures) === null || _e === void 0 ? void 0 : _e[0];
 ...
 */
async function getAdminPayPalEmail() {
    ...
    if (adminSettingsDoc.exists) {
        ...
        if (adminSettings === null || adminSettings === void 0 ? void 0 : adminSettings.paypalEmail) {
    ...
    if (!usersSnapshot.empty) {
        ...
        if (adminUser === null || adminUser === void 0 ? void 0 : adminUser.adminPayPalEmail) {
 ...
 */
exports.getAdminPayPalEmailCallable = functions.region('us-central1').https.onCall(async (data, context) => {
    // Verify authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
